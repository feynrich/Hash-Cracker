...
std::vector<bool> tobinsubseq(std::string input){
...
std::vector<std::bitset<32>> extrawords(std::bitset<512> message){
...
std::vector<std::bitset<32>> initsupvar(std::vector<std::bitset<32>> H, std::vector<std::bitset<32>> sqhash, std::vector<std::bitset<32>> word_64){
...
std::vector<std::bitset<32>> makebinaryhash(std::string pass){
    ...
    std::vector<std::bitset<32>> H = {0x6a09e667,
                                      0xbb67ae85,
                                      0x3c6ef372,
                                      0xa54ff53a,
                                      0x510e527f,
    ...
    std::vector<std::bitset<32>> root_3 = {0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1, 0x923f82a4, 0xab1c5ed5,
    ...
    for(int i = 0; i < N; i++){
        ...
        SUP = initsupvar(H, root_3, message);

        for(int i = 0; i < 8; i++){

            hashedblock.push_back(MERGE(H[i], SUP[i]));
...
std::string outputhash(std::vector<std::bitset<32>> binhash){
...
std::string sha256(std::string pass) {
