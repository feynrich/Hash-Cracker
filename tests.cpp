...
TEST_CASE("Checking MD5 hash"){
    REQUIRE(md5("huizalupa") == "d41cfbf9566b62945076ab3b308d047a");
...
TEST_CASE("Checking SHA1 hash"){
            ...
            //REQUIRE(sha256("artamonovsu123") == "ff100bcb9f2038f4a42c7e62f63049568a490ea0b3599cc0008d05b97c9143af");
}
